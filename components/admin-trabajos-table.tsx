...
const ESTADOS_PAGO: Record<string, { etiqueta: string; clase: string }> = {
  pendiente: { etiqueta: "Pendiente", clase: "bg-muted text-muted-foreground" },
  retenido: { etiqueta: "En custodia", clase: "bg-amber-500/10 text-amber-700 border-amber-500/30" },
  fondos_retenidos: { etiqueta: "En custodia", clase: "bg-amber-500/10 text-amber-700 border-amber-500/30" },
